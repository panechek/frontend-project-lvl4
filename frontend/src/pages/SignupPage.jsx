                    ...
                    <div className='card-body d-flex flex-column flex-md-row justify-content-around align-items-center p-5'>
                        ...
                        <Form
                            ...
                            <Form.Floating className='mb-3'>
                                    ...
                                    {errors.password && touched.password && <Form.Control.Feedback type="invalid" tooltip>
                                        {errors.password}
                                    </Form.Control.Feedback>}
                                </Form.Floating>
                            <Form.Floating className='mb-4'>
                                    ...
                                    {errors.confirmPassword && touched.confirmPassword && <Form.Control.Feedback type="invalid" tooltip>
                                        {errors.confirmPassword}
                                    </Form.Control.Feedback> }
                            </Form.Floating>
                            <Button
